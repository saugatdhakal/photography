    ...
    <section id="about" class="about">
      <div class="container">
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <a
              href="https://images.pexels.com/photos/837358/pexels-photo-837358.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800"
              data-lightbox="image-1"
              data-title="My caption"
            >
              <img
                class="img-fluid"
                src="https://images.pexels.com/photos/837358/pexels-photo-837358.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800"
                alt=""
            /></a>
          </div>
          <div class="col-lg-5 content">
            <h2>Professional Photographer from Nepal</h2>
